...
describe('log', function () {
	...
	describe('error', function () {
		it('should use util.format for arg processing', function () {
			...
			const message = `${time.toString().white} ${'error'.red} ${'totlog/tests/index.js'.cyan} obj {"a":1}`
	...
	describe('warn', function () {
		it('should use util.format for arg processing', function () {
			...
			const message = `${time.toString().white} ${'warn'.yellow} ${'totlog/tests/index.js'.cyan} obj {"a":2}`
	...
	describe('debug', function () {
		it('should use util.format for arg processing', function () {
			...
			const message = `${time.toString().white} debug ${'totlog/tests/index.js'.cyan} obj {"a":3}`
			consoleLog.should.be.calledWith(message)
		})
	})
})